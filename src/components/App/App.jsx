  ...
  useEffect(() => {
    ...
    async function getImages() {
      try {
        ...
        setImages(previousImages => (page === 1 ? data.results : [...previousImages, ...data.results]));
        ...
        setError(true);
        toast.error('Unable to load images right now. Please check the access key and try again later.');
      } finally {
  ...
  return (
    <>
      ...
      <main className="container">
        {error && !hasImages && <ErrorMessage message="Something went wrong while loading images. Please try again!" />}
